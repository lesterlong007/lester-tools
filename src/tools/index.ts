...
export { getRandomStr } from './base/base';
export { getCookie } from './base/base';
export { isMobile } from './base/base';
export { default as calendar } from './date/lunarCalendar';
export { lazyLoadImg } from './image/image';
